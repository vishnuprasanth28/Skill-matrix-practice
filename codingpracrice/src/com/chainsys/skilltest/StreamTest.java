	...
	public static void main(String[] args) {
        ...
        *****************************************************/
        Optional<Student> stud = students.stream()
            .filter(student -> student.getName().equals("Jesh"))
            .findFirst();
        ...
        *****************************************************/
        ...
        students.stream()
        .sorted(Comparator.comparing(Student::getAge)).forEach(s -> System.out.println(s.getAge()));
    
        students.stream().filter(s->s.getAge()>25).map(Student::getAge).forEach(s -> System.out.println(s));
